...
void SPIRAMInit(void)
{
	...
	SPIRAM_SPIBRG = (PERIPHERAL_FREQ - 1ul) / 2ul / SPIRAM_MAX_SPI_FREQ;
...
/*********************************************************************
 * Function:        void SPIRAMGetArray(WORD wAddress, unsigned char *vData, WORD wLength)
 *
 * PreCondition:    
 *
 * Input:           
...
void SPIRAMGetArray(WORD wAddress, unsigned char *vData, WORD wLength)
{
	...
	// Send address
	SPIRAM_SSPBUF = ((unsigned char *) &wAddress)[1];
	while (!SPIRAM_SPI_IF);
	Dummy = SPIRAM_SSPBUF;
	SPIRAM_SPI_IF = 0;
	SPIRAM_SSPBUF = ((unsigned char *) &wAddress)[0];
	while (!SPIRAM_SPI_IF);
	Dummy = SPIRAM_SSPBUF;
	SPIRAM_SPI_IF = 0;
...
/*********************************************************************
 * Function:        void SPIRAMPutArray(WORD wAddress, unsigned char *vData, WORD wLength)
 *
 * PreCondition:    
 *
 * Input:           
