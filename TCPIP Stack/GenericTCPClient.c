...
unsigned char ServerName[] = "www.google.com";
WORD ServerPort = 80;

// This is specific to this HTTP Client example
const unsigned char RemoteURL[] =
	"/search?as_q=Microchip&as_sitesearch=microchip.com";
...
void GenericTCPClient(void)
{
	...
	case SM_HOME:
		...
		MySocket =
			TCPOpen((DWORD) & ServerName[0], TCP_OPEN_RAM_HOST, ServerPort,
	...
	case SM_SOCKET_OBTAINED:
		...
		TCPPutROMString(MySocket, (const unsigned char *) "GET ");
