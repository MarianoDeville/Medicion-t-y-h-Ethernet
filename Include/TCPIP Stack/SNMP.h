 ...
 */
typedef unsigned char SNMP_ID;
typedef unsigned char SNMP_INDEX;

typedef union _SNMP_VAL {
	DWORD dword;
	WORD word;
	unsigned char byte;
	unsigned char v[sizeof(DWORD)];
}
SNMP_VAL;

/*********************************************************************
 * Function:        BOOL SNMPGetVar(SNMP_ID var, SNMP_INDEX index,
 *                                  unsigned char *ref, SNMP_VAL* val)
 *
 * PreCondition:    None
 *
 ...
 *                            If var data type is unsigned char, transfer data
 *                              in val->byte
...
/*********************************************************************
 * Function:        BOOL SNMPIsValidSetLen(SNMP_ID var, unsigned char len)
 *
 * PreCondition:    None
 *
 ...
 ********************************************************************/
#ifdef __SNMP_C
extern BOOL SNMPIsValidSetLen(SNMP_ID var, unsigned char len);
#endif
 ...
 *                            If var data type is unsigned char, variable
