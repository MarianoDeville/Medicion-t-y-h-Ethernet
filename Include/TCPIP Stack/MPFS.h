...
#else
typedef const unsigned char *MPFS;
...
BOOL MPFSInit(void);
MPFS MPFSOpen(unsigned char *name);
MPFS MPFSOpenROM(const unsigned char *name);
...
#if !defined(__MPFS_C)
extern unsigned char mpfsOpenCount;
extern MPFS _currentHandle;
extern unsigned char _currentCount;
#endif
...
/*********************************************************************
 * Macro:           unsigned char MPFSInUse(void)
 *
 * PreCondition:    None
 *
 * Input:           None
